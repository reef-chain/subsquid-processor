...
export const ReserveIdentifier = sts.bytes()
...
export type Type_264 = Type_264_Authority | Type_264_Balances | Type_264_Currencies | Type_264_EVM | Type_264_EvmAccounts | Type_264_Grandpa | Type_264_Identity | Type_264_ImOnline | Type_264_Indices | Type_264_Offences | Type_264_Poc | Type_264_Scheduler | Type_264_Session | Type_264_Staking | Type_264_Sudo | Type_264_System | Type_264_TechCouncil | Type_264_Tokens

export interface Type_264_Authority {
    __kind: 'Authority'
    value: AuthorityEvent
}

export interface Type_264_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_264_Currencies {
    __kind: 'Currencies'
    value: CurrenciesEvent
}

export interface Type_264_EVM {
    __kind: 'EVM'
    value: EVMEvent
}

export interface Type_264_EvmAccounts {
    __kind: 'EvmAccounts'
    value: EvmAccountsEvent
}

export interface Type_264_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_264_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_264_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_264_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_264_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_264_Poc {
    __kind: 'Poc'
    value: PocEvent
}

export interface Type_264_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_264_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_264_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_264_Sudo {
    __kind: 'Sudo'
    value: SudoEvent
}

export interface Type_264_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_264_TechCouncil {
    __kind: 'TechCouncil'
    value: TechCouncilEvent
}

export interface Type_264_Tokens {
    __kind: 'Tokens'
    value: TokensEvent
}
